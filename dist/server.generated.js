...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _models_company_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/company.model */ \"./server/models/company.model.js\");\n\n\nconst create = async (req, res) => {\n  const company = new _models_company_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"](req.body);\n\n  try {\n    await company.save();\n    return res.status(200).json({\n      message: 'Company Successfully created!'\n    });\n  } catch (err) {\n    return res.status(400).json({\n      error: errorHandler.getErrorMessage(err)\n    });\n  }\n};\n\nconst list = async (req, res) => {\n  try {\n    let Companies = await _models_company_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"].find();\n    res.json(Companies);\n  } catch (err) {\n    return res.status(400).json({\n      error: errorHandler.getErrorMessage(err)\n    });\n  }\n};\n\nconst remove = async (req, res) => {\n  try {\n    const deletedObject = await _models_company_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"].findByIdAndRemove(req.params.id);\n    res.status(200).json(deletedObject);\n  } catch (error) {\n    console.error(error);\n  }\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\n  create,\n  list,\n  remove\n});\n\n//# sourceURL=webpack://occp/./server/controllers/company.controller.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _models_location_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/location.model */ \"./server/models/location.model.js\");\n/* harmony import */ var _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/dbErrorHandler */ \"./server/helpers/dbErrorHandler.js\");\n\n\n\nconst create = async (req, res) => {\n  const location = new _models_location_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"](req.body);\n\n  try {\n    await location.save();\n    return res.status(200).json({\n      message: 'Location Successfully created!'\n    });\n  } catch (err) {\n    return res.status(400).json({\n      error: _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getErrorMessage(err)\n    });\n  }\n};\n\nconst list = async (req, res) => {\n  try {\n    const locations = await _models_location_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"].find().populate('chargerPoints', \"status charger_box_id connectors\");\n    res.json(locations);\n  } catch (error) {\n    res.status(400).json({\n      error: _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getErrorMessage(error)\n    });\n  }\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\n  create,\n  list\n});\n\n//# sourceURL=webpack://occp/./server/controllers/location.controller.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _models_transaction_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/transaction.model */ \"./server/models/transaction.model.js\");\n/* harmony import */ var _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../helpers/dbErrorHandler */ \"./server/helpers/dbErrorHandler.js\");\n\n\n\nconst create = async (req, res) => {\n  const transaction = new _models_transaction_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"](req.body);\n\n  try {\n    await transaction.save();\n    return res.status(200).json({\n      message: 'Transaction Successfully created!'\n    });\n  } catch (err) {\n    return res.status(400).json({\n      error: _helpers_dbErrorHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getErrorMessage(err)\n    });\n  }\n};\n\nconst list = async (req, res) => {\n  const {\n    pageSize = 50,\n    page = 0,\n    search\n  } = req.query;\n\n  try {\n    const transactions = await _models_transaction_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"].find().limit(Number(pageSize)).skip(Number(page) * Number(pageSize)).populate({\n      path: 'user',\n      select: 'name email'\n    }).populate({\n      path: 'chargerPointId',\n      select: 'charger_box_id connectors'\n    }).sort({\n      start_timestamp: -1\n    }).exec();\n    const total = await _models_transaction_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"].countDocuments();\n    let filterTransactions = transactions;\n\n    if (search && search.length > 0) {\n      filterTransactions = transactions.filter(transaction => transaction.chargerPointId?.charger_box_id.includes(search) || transaction.user?.email.includes(search));\n    }\n\n    return res.status(200).json({\n      transactions: filterTransactions,\n      total: total\n    });\n  } catch (error) {\n    console.error(error);\n    return res.status(500).json({\n      error: 'Internal server error'\n    });\n  }\n}; // const list = async (req, res) => {\n//     try {\n//         const page = parseInt(req.query.page) || 1;\n//         const limit = parseInt(req.query.limit) || 10;\n//         const startIndex = (page - 1) * limit;\n//         const endIndex = page * limit;\n//         const total = await Transaction.countDocuments();\n//         const transactions = await Transaction\n//                                   .find()\n//                                   .populate('users')\n//                                   .skip(startIndex)\n//                                   .limit(limit)\n//                                   .exec();\n//         res.json({\n//             total: total,\n//             page: page,\n//             limit: limit,\n//             transactions: transactions\n//         });\n//     } catch (err) {\n//         return res.status(400).json({\n//             error: errorHandler.getErrorMessage(err),\n//         });\n//     }\n// };\n\n\nconst read = async (req, res) => {\n  let transactions = await _models_transaction_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"].find({\n    chargerPointId: req.params.idCP\n  }).exec();\n  res.json(transactions);\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\n  create,\n  list,\n  read\n});\n\n//# sourceURL=webpack://occp/./server/controllers/transaction.controller.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_0__);\n\nconst Schema = (mongoose__WEBPACK_IMPORTED_MODULE_0___default().Schema);\nconst CompanySchema = new Schema({\n  name: {\n    type: String,\n    trim: true,\n    required: 'Name is required'\n  },\n  email: {\n    type: String,\n    trim: true,\n    unique: 'Email already exists',\n    match: [/.+\\@.+\\..+/, 'Please fill a valid email address'],\n    required: 'Email is required'\n  },\n  address: {\n    type: String,\n    required: \"Address is required\"\n  },\n  city: {\n    type: String,\n    required: true\n  },\n  country: {\n    type: String,\n    required: true\n  },\n  phone: {\n    type: String,\n    trim: true,\n    required: \"Phone is required\"\n  },\n  users: [{\n    type: Schema.Types.ObjectId,\n    ref: \"User\"\n  }],\n  created: {\n    type: Date,\n    default: Date.now\n  },\n  updated: Date\n});\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (mongoose__WEBPACK_IMPORTED_MODULE_0___default().model('Company', CompanySchema));\n\n//# sourceURL=webpack://occp/./server/models/company.model.js?");
...
/***/ "./server/models/location.model.js":
/*!*****************************************!*\
  !*** ./server/models/location.model.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_0__);\n\nconst Schema = (mongoose__WEBPACK_IMPORTED_MODULE_0___default().Schema);\nconst LocationSchema = new Schema({\n  name: {\n    type: String,\n    required: true\n  },\n  address: {\n    type: String,\n    required: true\n  },\n  city: {\n    type: String,\n    default: true\n  },\n  latitude: {\n    type: String,\n    default: true\n  },\n  longitude: {\n    type: String,\n    default: true\n  },\n  chargerPoints: [{\n    type: Schema.Types.ObjectId,\n    ref: \"ChargerPoint\"\n  }]\n}, {\n  timestamps: true\n});\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (mongoose__WEBPACK_IMPORTED_MODULE_0___default().model('Location', LocationSchema));\n\n//# sourceURL=webpack://occp/./server/models/location.model.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _controllers_company_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../controllers/company.controller */ \"./server/controllers/company.controller.js\");\n\n\nconst router = express__WEBPACK_IMPORTED_MODULE_0___default().Router();\nrouter.route('/ocpp/company').get(_controllers_company_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].list).post(_controllers_company_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].create);\nrouter.route('/ocpp/company/:id') //.put(companyController.update)\n.delete(_controllers_company_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].remove);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (router);\n\n//# sourceURL=webpack://occp/./server/routes/company.routes.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _controllers_dashboard_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../controllers/dashboard.controller */ \"./server/controllers/dashboard.controller.js\");\n\n\nconst router = express__WEBPACK_IMPORTED_MODULE_0___default().Router();\nrouter.route('/ocpp/dashboard').get(_controllers_dashboard_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getDashboardStats);\nrouter.route('/ocpp/dashboard/graphs').get(_controllers_dashboard_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getDashboardGrap);\nrouter.route('/ocpp/dashboard/charger-points-graphs').get(_controllers_dashboard_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getDashboardGraphs);\nrouter.route('/ocpp/dashboard/charger-points').get(_controllers_dashboard_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getCPStats);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (router);\n\n//# sourceURL=webpack://occp/./server/routes/dashboard.routes.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _controllers_location_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../controllers/location.controller */ \"./server/controllers/location.controller.js\");\n\n\nconst router = express__WEBPACK_IMPORTED_MODULE_0___default().Router();\nrouter.route('/ocpp/locations').get(_controllers_location_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].list).post(_controllers_location_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].create);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (router);\n\n//# sourceURL=webpack://occp/./server/routes/location.routes.js?");
