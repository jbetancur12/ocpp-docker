...
import { useGetDashboardCPGraphQuery } from 'state/api';
...
const DatePickerRange = ({setGraphData, setUnit, setIsLoadingGraph, id, setDateTitle}) => {
    ...
    const { data, isLoading } = useGetDashboardCPGraphQuery(params);
    setGraphData(data)
