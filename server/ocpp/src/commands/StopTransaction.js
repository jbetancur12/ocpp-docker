...
import requestSchema from "../../ocpp-1.6-schemas/StopTransaction";
import responseSchema from "../../ocpp-1.6-schemas/StopTransactionResponse";

export const REASON_ACCEPTED = "Accepted";
export const REASON_EMERGENCYSTOP = "EmergencyStop";
export const REASON_EVDISCONNECTED = "EVDisconnected";
export const REASON_HARDRESET = "HardReset";
export const REASON_LOCAL = "Local";
export const REASON_OTHER = "Other";
export const REASON_POWERLOSS = "PowerLoss";
export const REASON_REBOOT = "Reboot";
export const REASON_REMOTE = "Remote";
export const REASON_SOFTRESET = "SoftReset";
export const REASON_UNLOCKCOMMAND = "UnlockCommand";
export const REASON_DEAUTHORIZED = "DeAuthorized";
...
export const MEASURAND_ENERGY_ACTIVE_EXPORT_REGISTER =
  "Energy.Active.Export.Register";
export const MEASURAND_ENERGY_ACTIVE_IMPORT_REGISTER =
  "Energy.Active.Import.Register";
export const MEASURAND_ENERGY_REACTIVE_EXPORT_REGISTER =
  "Energy.Reactive.Export.Register";
export const MEASURAND_ENERGY_REACTIVE_IMPORT_REGISTER =
  "Energy.Reactive.Import.Register";
export const MEASURAND_ENERGY_ACTIVE_EXPORT_INTERVAL =
  "Energy.Active.Export.Interval";
export const MEASURAND_ENERGY_ACTIVE_IMPORT_INTERVAL =
  "Energy.Active.Import.Interval";
export const MEASURAND_ENERGY_REACTIVE_EXPORT_INTERVAL =
  "Energy.Reactive.Export.Interval";
export const MEASURAND_ENERGY_REACTIVE_IMPORT_INTERVAL =
